========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet CopyPasteClient
========================================================================

AppWizard a créé cette application CopyPasteClient pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application CopyPasteClient.


CopyPasteClient.vcxproj
...
CopyPasteClient.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) CopyPasteClient.pch et un fichier de type précompilé nommé StdAfx.obj.
